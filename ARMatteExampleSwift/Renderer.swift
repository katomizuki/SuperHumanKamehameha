...
class Renderer {
    ...
    func update() {
        ...
        if viewportSizeDidChange {
            print("ああああああああああああああああああああああああああああああああああああああああここここここここ")
        ...
        // キャプチャ画像＋ブラー（白・黄色）合成
        guard let renderPassDescriptor = mtkView.currentRenderPassDescriptor, let currentDrawable = mtkView.currentDrawable else {
            print("合成できないやん！！")
            return
        }
